    ...
    return (
      ...
      >
        ...
        <div className="mb-3 w-100 text-center">
          <label htmlFor="avatar" className="form-label fw-bold text-light">Upload Avatar</label>
          <input type="file" className="form-control bg-dark text-white border-0" id="avatar" name="avatar" onChange={handleChange} />
          {errors.avatar && <p className="text-danger robotic-font-info">{errors.avatar}</p>}
        </div>
  
        {/* Full Name */}
        <div className="mb-3 w-100">
          <label htmlFor="name" className="form-label fw-bold text-light">Full Name</label>
        ...
        {/* GitHub Username */}
        <div className="mb-3 w-100">
          <label htmlFor="githubUsername" className="form-label fw-bold text-light">GitHub Username</label>
